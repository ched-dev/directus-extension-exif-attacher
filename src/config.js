...
const EXIF_DATA_MODELS_JSON_CONFIG_PATH = process.env.EXIF_DATA_MODELS_JSON_CONFIG_PATH || './exif-data-models-config.json';
// not user defined
...
function saveConfigJSON(config) {
  return new Promise((resolve, reject) => {
    ...
    fs.writeFile(env.JSON_CONFIG_FILEPATH, jsonData, (err) => {
      if (err) {
